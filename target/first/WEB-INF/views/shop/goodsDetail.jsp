...
// 	console.log(resultList);
	...
	comSubmit.addParam("resultList", {
		'ORDER_COLOR'		   : $("input[name=ORDER_COLOR]").eq(0).val(),
		'ORDER_SIZE'		   : $("input[name=ORDER_SIZE]").eq(0).val(),
		'BASKET_GOODS_AMOUNT'  : $("input[name=BASKET_GOODS_AMOUNT]").eq(0).val(),
		'MEMBER_NO'  		   : $("input[name=MEMBER_NO]").eq(0).val(),
		'IDX' 				   : $("input[name=IDX]").eq(0).val()
	});
	comSubmit.submit();
